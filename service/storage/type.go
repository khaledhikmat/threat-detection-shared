...
type IService interface {
	...
	RetrieveRecordingClip(ctx context.Context, clip equates.RecordingClip) ([]byte, error)
	DownloadRecordingClip(ctx context.Context, clip equates.RecordingClip) ([]byte, error)
	Finalize()
}
